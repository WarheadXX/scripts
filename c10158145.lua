...
function c10158145.get_zone(c,seq)
	local zone=0
	---Left Markers
	if seq == 0 and c:IsLinkMarkerLeft() then zone=2 end
	if seq == 1 and c:IsLinkMarkerLeft() then zone=4 end
	if seq == 2 and c:IsLinkMarkerLeft() then zone=8 end
	if seq == 3 and c:IsLinkMarkerLeft() then zone=16 end
	--Right Markers
	if seq == 1 and c:IsLinkMarkerRight() then zone=1 end
	if seq == 2 and c:IsLinkMarkerLeft() then zone=2 end
	if seq == 3 and c:IsLinkMarkerLeft() then zone=4 end
	if seq == 4 and c:IsLinkMarkerLeft() then zone=8 end
	return zone
end
