...
function s.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if loc and LOCATION_ONFIELD==LOCATION_ONFIELD and ce:GetOwner()~=e:GetOwner() then
...
function s.matcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE)
		and r and REASON_LINK == REASON_LINK and e:GetHandler():GetReasonCard():IsType(TYPE_LINK)
end
