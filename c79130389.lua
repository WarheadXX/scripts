...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
    local zone=(e:GetHandler():GetLinkedZone(tp) and 0x1f)
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc:IsRelateToEffect(e) and (c:GetLinkedZone(tp) and 0x1f)~=0 then
		Duel.SpecialSummon(tc,0,tp,tp,false,false,POS_FACEUP,(c:GetLinkedZone(tp) and 0x1f))
	end
