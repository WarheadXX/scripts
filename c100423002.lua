...
function s.costfilter(c,tp,ft)
	return c:IsRace(RACE_CYBERSE) and (c:IsControler(tp) or c:IsFaceup())
...
function s.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return ft>-1 and Duel.CheckReleaseGroup(tp,s.costfilter,1,nil,nil) end
	--local sg=Duel.SelectReleaseGroupCost(tp,s.costfilter,1,1,false,nil,nil,tp,ft)
	local sg=Duel.SelectReleaseGroup(tp,s.costfilter,1,1,nil,ft)
