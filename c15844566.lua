...
function c15844566.initial_effect(c)
	--link summon
	c:EnableReviveLimit()
	aux.AddLinkProcedureCT(c,nil,3,3)
	--negate
...
-- function c15844566.cfilter(e,tp,eg,ep,ev,re,r,rp,c,g)
	-- local c=e:GetHandler()
	-- return c:GetLinkedGroup() and not c:IsStatus(STATUS_BATTLE_DESTROYED)
	-- --g:IsContains(c)
-- end
-- function c15844566.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
	-- local lg=e:GetHandler():GetLinkedGroup()
	-- if chk==0 then return Duel.CheckReleaseGroup(tp,c15844566.cfilter,1,false,nil,nil,lg) end
	-- local g=Duel.SelectReleaseGroup(tp,c15844566.cfilter,1,1,false,nil,nil,lg)
