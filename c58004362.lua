...
function s.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	-- if chk==0 then return Duel.GetCustomActivityCount(id,tp,ACTIVITY_SPSUMMON)==0 and Duel.CheckReleaseGroup(tp,s.cfilter,1,false,nil,nil,tp) end
	if chk==0 then return Duel.GetCustomActivityCount(id,tp,ACTIVITY_SPSUMMON)==0 and Duel.CheckReleaseGroup(tp,s.cfilter,1,nil) end
