...
function c30114823.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(30114823,1))
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e3:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_CANNOT_DISABLE)
	e3:SetCode(EVENT_BE_MATERIAL)
	e3:SetCountLimit(1,30114824)
	e3:SetCondition(c30114823.matcon)
	e3:SetOperation(c30114823.matop)
	c:RegisterEffect(e3)
end
function c30114823.matcon(e,tp,sg,mg,lc,og,chk)
	return bit.band(e:GetHandler():GetPreviousLocation(),LOCATION_HAND)~=0 and codeGenerator == 30114824
end
function c30114823.matop(e,tp,eg,ep,ev,re,r,rp)
...
function c30114823.extracon(c,e,tp,sg,mg,lc,og,chk)
	...
	(sg:Filter(c30114823.flagcheck,nil):GetCount())<2
end
