...
function c96380700.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local zone=c:GetFreeLinkedZone() and 0x1f
	...
	local g=Duel.SelectTarget(tp,c96380700.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp,c:GetFreeLinkedZone() and 0x1f,tc:GetFirst():GetOriginalCode())
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,g,1,tp,LOCATION_GRAVE)
end
function c96380700.spop(e,tp,eg,ep,ev,re,r,rp)
	local zone=e:GetHandler():GetFreeLinkedZone() and 0x1f
