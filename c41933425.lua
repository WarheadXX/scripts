...
c41933425.listed_names={ 89943723 }
...
function c41933425.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(c41933425.cfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,nil)
...
function c41933425.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	-- local sg=Duel.SelectMatchingCard(tp,c41933425.filter,tp,LOCATION_GRAVE+LOCATION_HAND+LOCATION_DECK,0,2,2,nil,e,tp)
...
function c41933425.spcfilter(c,tp)
	return c:IsPreviousPosition(POS_FACEUP) and aux.IsMaterialListCode(c,89943723)
