...
function s.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if ((sel and 0x1)==0x1) then
		s.handop(e,tp,eg,ep,ev,re,r,rp)
	end
	if ((sel and 0x2)==0x2) then
		s.monop(e,tp,eg,ep,ev,re,r,rp)
	end
	if ((sel and 0x4)==0x4) then
