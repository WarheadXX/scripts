...
function c75130221.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(75130221,1))
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e3:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_CANNOT_DISABLE)
	e3:SetCode(EVENT_BE_MATERIAL)
	e3:SetCountLimit(1,75130222)
	e3:SetCondition(c75130221.matcon)
	e3:SetOperation(c75130221.matop)
	c:RegisterEffect(e3)
end
function c75130221.matcon(e,tp,sg,mg,lc,og,chk)
	return bit.band(e:GetHandler():GetPreviousLocation(),LOCATION_HAND)~=0 and codeRadiator == 75130221
end
function c75130221.matop(e,tp,eg,ep,ev,re,r,rp)
...
function c75130221.extracon(c,e,tp,sg,mg,lc,og,chk)
	...
	(sg:Filter(c75130221.flagcheck,nil):GetCount())<2
end
