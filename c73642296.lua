...
function c73642296.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return (ex1 and loc1:IsLocation(LOCATION_GRAVE)) or (ex2 and loc2:IsLocation(LOCATION_GRAVE)) 
		or (ex3 and loc3:IsLocation(LOCATION_GRAVE)) or (ex4 and loc4:IsLocation(LOCATION_GRAVE)) 
